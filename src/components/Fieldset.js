import { Description, Field, Fieldset as FieldsetTailwind, Input, Label, Legend, Select, Textarea } from '@headlessui/react'
...
export default function Fieldset() {
  return (
    <div className="w-full max-w-lg px-4">
      <FieldsetTailwind className="space-y-6 rounded-xl bg-white/5 p-6 sm:p-10">
