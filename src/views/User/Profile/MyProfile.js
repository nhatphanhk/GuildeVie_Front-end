...
import { AppBar, Avatar, Box, Button, Grid, IconButton, List, ListItem, ListItemIcon, ListItemText, Paper, Toolbar, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from '@mui/material';
...
const MyProfile = () => {
    ...
    return (
        <Box>
            {/* Profile Section */}
            <Box component={Paper} elevation={3} sx={{ position: 'sticky', top: 0, zIndex: 1000, bgcolor: 'background.paper', p: 2, mb: 2, width: '80%', margin: 'auto' }}>
            ...
            {/* Menu */}
            <AppBar position="sticky" color="default" sx={{ width: '80%', margin: 'auto' }}>
                <Toolbar>
